...
Na začiatku si študenti pripomenú o čom je OpenLab, jeho princípy, hodnotenie, kódexom študenta a iné praktické veci.

Učebné osnovy sú potom rozdelené na týždne, počas ktorých sa študenti postupne oboznámia s HTML a CSS, až po pokročilé témy.
...
Témami týždňov sú: Úvod do vývoja webu a základy HTML, HTML štýly a úvod do CSS, HTML text, HTML a CSS farby, HTML odkazy, obrázky a základné CSS štýlovanie, HTML tabuľky, zoznamy a CSS štýlovanie tabuliek, CSS písma a HTML formuláre, CSS rozloženie a formuláre, pokročilé HTML, pokročilé CSS, responzívny dizajn a flexbox, HTML grafika a CSS mriežka, HTML multimédia a API, pokročilé CSS (bonus), pokračovanie na projekte (osobné HTML a CSS portfólio webových stránok) a nakoniec záverečné hodnotenie.

V každom týždni sa študenti zoznámia s konkrétnymi témami a naučia sa ich prakticky aplikovať. Študenti sa tak naučia vytvárať a štylizovať webové stránky pomocou HTML a CSS, a to od základov až po pokročilé techniky.
...
- **Lekcie**: HTML Colors, HTML RGB, HTML RGBA, HTML Hex, HTML HSL, HTML HSLA, CSS Colors, CSS RGB, CSS RGBA, CSS Hex, CSS HSL, CSS HSLA
...
- **Cieľ**: Students will learn how to create links in HTML, work with images, and the basics of styling with CSS.
...
- **Cvičenia**: Students should practice creating different types of HTML links, working with images in HTML including the use of image maps and the `<picture>` element. In addition, they will learn how to modify the appearance of web pages using various CSS properties, including styling backgrounds, borders, and text. Students should create their own CSS styles and apply them to HTML pages for practical use of learned knowledge.
...
- **Cieľ**: Cieľom tohto týždňa je poskytnúť študentom pokročilé pochopenie HTML, vrátane blokových a inline prvkov, atribútov `class` a `id`, práce s `iframes`, JavaScriptu v HTML, ciest k súborom, prvku `head`, techník a prvkov HTML rozloženia, prvkov počítačového kódu, sémantických prvkov, štýlového sprievodcu HTML, entít, symbolov, použitia emodži v HTML, kódovania (znakové sady), uniformných identifikátorov zdrojov a rozdielov medzi HTML a XHTML.
...
- **Cvičenia**: Študenti by mali navrhnúť a implementovať rôzne responzívne web dizajny a flexbox riešenia. Mali by tiež experimentovať s rôznymi mediálnymi otázkami, responzívnymi obrázkami a videami a flexbox vlastnosťami. Praktické cvičenia by mali byť integrované do každej lekcie, aby študenti mohli aplikovať a otestovať svoje vedomosti a techniky.

### 12. týždeň: HTML Grafika a CSS Grid

- **Cieľ**: Študenti sa oboznámia s možnosťami tvorby grafiky v HTML pomocou Canvas a SVG. Ďalej sa naučia o možnostiach tvorby rozložení s použitím CSS Grid, vrátane práce s Grid kontajnermi a Grid položkami.
...
- **Cieľ**: Študenti získajú základné porozumenie o multimédiách v HTML a zoznámia sa s niekoľkými dôležitými HTML API. Budú rozumieť, ako vkladať rôzne typy médií do webových stránok, vrátane video a zvuku, a ako využívať API pre geolokáciu, pretiahnutie a pustenie, webové úložisko, webové pracovníky a SSE.
